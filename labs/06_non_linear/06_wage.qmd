...
In this lab we will work with four packages: `tidyverse` which is a collection of packages for doing data analysis in a "tidy" way, `tidymodels` for statistical model coefficients, and `splines` for our splines models.
