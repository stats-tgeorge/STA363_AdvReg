...
Homeworks will be graded for correctness. I will evaluate between a subset of the questions, to all of the questions included in a homework to evaluate. The goal is the practice the application of the method and then be able to interpret the result. 

##### Participation

This will be measured by attending class, and working on labs and class examples. With class work, you will save your script files in a folder that I can view on the RStudio server. 

##### Mini-Project

This class includes a variety of related techniques where generally only 1 of them is the correct technique for particular research questions. For this reason, we will do mini "projects" at the end of each major new approach. This will finding data, cleaning the data, and then applying the technique. 

##### Exams

There will be in class exams on {{< var course.exam_dates >}}. There will be two components. Component 1 will be on these dates and you will get a choice of oral or written. Component 2 will be take-home, open-book and notes. 
